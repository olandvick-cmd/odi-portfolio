...
export default function Hero({ avatarUrl, resumeUrl }: HeroProps) {
  // Use the admin dashboard image if it exists, otherwise fall back to your static asset file
  const displayImage = avatarUrl || "/images/profile.png";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold leading-[1.02] tracking-[-0.04em] mb-8">
              Hi, I’m <span className="text-purple-500">Odi</span>
              <br />
              I build digital products & brands that create impact.
            </h1>
            ...
            <div className="flex flex-wrap gap-5 mb-14">
              ...
              {/* Converted button to an anchor tag for clean native browser downloads */}
              <a 
                href={resumeUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="border border-white/10 hover:border-purple-500/30 hover:bg-white/[0.03] transition px-8 py-4 rounded-2xl flex items-center gap-3 cursor-pointer"
              >
                <Download size={18} />
                Download Resume
              </a>
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-8 text-gray-300">
                <span className="font-semibold hover:text-white transition">Homely</span>
                <span className="font-semibold hover:text-white transition">Vetex</span>
                <span className="font-semibold hover:text-white transition">VTU</span>
                <span className="font-semibold hover:text-white transition">Telecom Hub</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative w-[320px] h-[420px] md:w-[400px] md:h-[520px] rounded-[40px] overflow-hidden border border-white/10 bg-gradient-to-b from-white/10 to-white/[0.02] backdrop-blur-xl shadow-2xl">
              <Image
                ...
                unoptimized={!!avatarUrl} // Prevents Next.js optimization issues with remote Supabase URLs
              />
            </div>
